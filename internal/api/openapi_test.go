...
var pendingSpec = []string{
	...
	"POST /api/media-tools/install",
	"POST /api/media-tools/install/cancel",
	"POST /api/peers",
	"POST /api/playlists",
	...
	"PUT /api/people/peers/{fingerprint}/{person}/presence",
	"PUT /api/playlists/{id}/entries",
	"PUT /api/profile/peer-visibility",
