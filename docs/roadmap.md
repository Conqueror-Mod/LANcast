...
**Nothing sits unreleased.** v0.8.17 shipped the eleven commits that had
accumulated, four of which change what a viewer gets. That line spent a day
reading "one cosmetic fix", then "six commits", then "nine"; each edit was a
smaller lie than the last, which is what a release is for.
